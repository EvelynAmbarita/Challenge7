...
data class MovieDetailsResponse(
    ...
    @SerializedName("genres"                ) var genres              : List<Genres>                   = listOf(),
    ...
    @SerializedName("production_companies"  ) var productionCompanies : List<ProductionCompanies>      = listOf(),
    @SerializedName("production_countries"  ) var productionCountries : List<ProductionCountries>      = listOf(),
    @SerializedName("release_date"          ) var releaseDate         : String?                        = null,
    @SerializedName("revenue"               ) var revenue             : Int?                           = null,
    @SerializedName("runtime"               ) var runtime             : Int?                           = null,
    @SerializedName("spoken_languages"      ) var spokenLanguages     : List<SpokenLanguages>          = listOf(),
